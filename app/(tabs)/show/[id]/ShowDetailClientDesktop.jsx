...
function CastGallery({ people, onSelect }) {
  return (
    <div className="grid mt-4" style={{ gridTemplateColumns: "repeat(3, 1fr)", rowGap: 20, columnGap: 8 }}>
      {people.map((c) => {
        // Cast/crew labels follow App Language (server fetch), not Readable.
        // Readable only switches show/movie titles via resolveTitle.
      ...
      <div className="pb-8" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div className="show-desktop-layout">
          ...
          <section className="show-desktop-strip" aria-label="Show details">
            {primaryProvider ? (
              (primaryProvider.href || watchProviders?.link) ? (
                <a
                  className="show-desktop-strip-item is-watch"
                  href={primaryProvider.href || watchProviders.link}
                  target="_blank"
                  rel="noopener noreferrer"
                >
