...
export default function Page() {
  ...
  // Pointer-based drag — see the shows Favorites page's identical block
  // for why (native HTML5 drag-and-drop is mouse-only, so this never
  // worked on a touch device/PWA at all).
