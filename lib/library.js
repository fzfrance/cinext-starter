...
export const GENRE_ICON = {
  ...
  "News": "tv",
  "Talk": "tv",
  // Movie-only additions — no key collisions with the TV list above (every
  // shared concept, e.g. "Mystery"/"Animation"/"Comedy"/"Family"/
  // "Documentary", already uses the same string on both lists). Genres with
  // no obviously-matching icon (Horror, Thriller, Music, Romance, History,
  // "TV Movie") are left unmapped on purpose — Aisle.jsx already falls back
  // to a plain "tv" icon for anything missing here.
