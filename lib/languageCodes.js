...
export function resolveTitle(item, readableLanguages) {
  // Readable Languages affect *titles only* (prefer original_title when that
  // language is marked readable). Synopsis/overview and cast/crew copy always
  // follow App Language at fetch time — never swap those here.
