...
export async function getMyRatingsForUser(userId) {
  ...
  const entries = [
    ...
    ...movieRows.map((r) => ({ movieId: r.movieId, seasonNumber: null, mediaType: "movie", rating: r.rating, mood: r.mood, characterName: r.characterName, text: r.text, isAuto: false, activityAt: new Date(r.reviewDate) })),
