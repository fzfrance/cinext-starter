...
const ProfileDvdCase = forwardRef(function ProfileDvdCase({ show, onOpen }, ref) {
  ...
  return (
    <button
      ...
      style={{ width: SLOT_W, height: COVER_H + 10, position: "relative", flexShrink: 0, background: "none", border: "none", padding: 0, cursor: "pointer" }}
    >
      ...
      <div style={{ position: "absolute", left: 6, top: 0, width: COVER_W, height: COVER_H, perspective: 1100 }}>
        ...
        >
          ...
          {/* Thickness / plastic edge — same as ShelfCase */}
